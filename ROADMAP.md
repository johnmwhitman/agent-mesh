...
7. **Slice 4C-1 authenticated-local adapter proof** - bounded evidence-alpha
   ...
   public/auth/network/storage/runtime activation. The 54-case mandatory corpus,
...
- [ ] **Slice 4C-1: principal-bound authenticated-local semantic path** —
  ...
  The current 54-case direct TypeScript/Python evidence and sidecar fixtures do
