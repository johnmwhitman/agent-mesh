...
**Source version:** `0.21.1` · **MCP surface:** **38 MCP tools** ·
**current suite contract:** **1815/1815** tests collected, plus typecheck and build
...
the current 1815-test contract above; those require their own fresh 9/9 run
before merge.
