...
**current suite contract:** **1779/1779** tests collected, plus typecheck and build
...
the current 1779-test contract above; those require their own fresh 9/9 run
before merge.
...
- The ledger fixture corpus contains **84 total** cases: **59 caught**, **15
