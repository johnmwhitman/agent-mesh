...
**Source version:** `0.21.1` · **MCP surface:** **39 MCP tools** ·
**current suite contract:** **1898/1898** tests collected, plus typecheck and build
...
the current 1809-test contract above; those require their own fresh 9/9 run
before merge.
