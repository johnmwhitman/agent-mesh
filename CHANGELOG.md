...
- **Coverage ledger: closed the `binding` row's interval-edges subfamily onto the auth-context baseline.** Six new
  ...
  and keeps `evaluation_time_ms=100` so the boundary semantics are isolated. Corpus 49→55.
  ...
  shrinks the family pin to 5. Suite 1769→1770.
