...
| oracle/results | all four non-admission verdicts, unavailable, throw, unseen plan, unseen-only expiry, and exact query | **CLOSED bounded subfamily:** malformed oracle; denial hides malformed oracle and throw; source-derived rejected-code inventory pinned to the corpus in both witnesses | every rejected-code inventory |
