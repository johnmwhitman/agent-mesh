...
Base reviewed: `2760310` (origin/main). Corpus: 69 mandatory raw-text cases in
...
| evidence | one invalid field representative | **CLOSED bounded subfamily:** provenance; issued-at equality; expires-at equality; lifetime 300000/300001; adapter/opaque/audience/session grammar classes; time type/range classes; provenance literal variants; issuance-vs-evaluation and issuance-vs-expiry orderings | — |
