...
Base reviewed: `2760310` (origin/main). Corpus: 75 mandatory raw-text cases in
...
| evidence | one invalid field representative | **CLOSED bounded subfamily:** provenance; issued-at equality; expires-at equality; lifetime 300000/300001; field-type (adapter_id/principal_ref/issued_at_ms/expires_at_ms non-numeric/non-string); field-grammar (adapter_id leading-dash, principal_ref empty-string); adapter/opaque/audience/session grammar classes; time type/range classes; provenance literal variants; issuance-vs-evaluation and issuance-vs-expiry orderings — every evidence-field type-vs-grammar-vs-gate axis is now pinned (44 base + 6 grammar + 25 gates = 75 cases) | none |
