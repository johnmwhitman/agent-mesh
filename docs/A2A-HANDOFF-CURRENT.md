...
- The runtime registry is provider-neutral. OpenCode is the default; Kimi,
  ...
  durable mode.
- Slice 4C-1 is a test-only offline local-admission evaluator. Its 75 mandatory cases (49 origin/main + 13 adjacent A00-A13 mutation canaries + 13 later-only precedence controls),
