...
> evaluator, independent Python witness, shared 52-case corpus (49 baseline + 3
> binding rules-count 0/256/257 boundary gates), and closed
...
The current evidence-alpha corpus has 52 mandatory cases (49 baseline + 3
binding rules-count 0/256/257 boundary gates). It proves the closed
