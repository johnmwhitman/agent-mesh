...
The current evidence-alpha corpus has 75 mandatory cases (49 origin/main + 13 adjacent A00-A13 mutation canaries + 13 later-only precedence controls). It proves the closed
