...
provider call, release, or activation. The shared corpus currently has 75 mandatory cases (49 origin/main + 13 adjacent A00-A13 mutation canaries + 13 later-only precedence controls), an independent Python witness, strict mutation canaries, and
