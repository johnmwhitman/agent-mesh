...
provider call, release, or activation. The shared corpus currently has 52
mandatory cases (49 baseline + 3 binding rules-count 0/256/257 boundary gates),
an independent Python witness, strict mutation canaries, and
