...
[`test/fixtures/corpus/`](test/fixtures/corpus/README.md) is a corpus of 92 deliberately
...
|---|---|---|
| `caught` | 65 | An overclaim — the ledger asserts something its own records don't support. Raises an error and fails the ledger. |
| `anomaly` | 17 | Surprising, but claims no more than the records support. Warning only, and deliberately *not* counted as caught. |
