...
[`test/fixtures/corpus/`](test/fixtures/corpus/README.md) is a corpus of 93 deliberately
...
|---|---|---|
| `caught` | 66 | An overclaim — the ledger asserts something its own records don't support. Raises an error and fails the ledger. |
